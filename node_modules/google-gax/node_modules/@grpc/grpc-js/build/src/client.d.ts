...
import { ClientDuplexStream, ClientReadableStream, ClientUnaryCall, ClientWritableStream, ServiceError, SurfaceCall } from 'google-gax/node_modules/@grpc/grpc-js/build/src/call';
import { CallCredentials } from 'google-gax/node_modules/@grpc/grpc-js/build/src/call-credentials';
import { Channel } from 'google-gax/node_modules/@grpc/grpc-js/build/src/channel';
import { ChannelCredentials } from 'google-gax/node_modules/@grpc/grpc-js/build/src/channel-credentials';
import { ChannelOptions } from 'google-gax/node_modules/@grpc/grpc-js/build/src/channel-options';
import { Metadata } from 'google-gax/node_modules/@grpc/grpc-js/build/src/metadata';
import { ClientMethodDefinition } from 'google-gax/node_modules/@grpc/grpc-js/build/src/make-client';
import { Interceptor, InterceptorProvider } from 'google-gax/node_modules/@grpc/grpc-js/build/src/client-interceptors';
import { ServerUnaryCall, ServerReadableStream, ServerWritableStream, ServerDuplexStream } from 'google-gax/node_modules/@grpc/grpc-js/build/src/server-call';
